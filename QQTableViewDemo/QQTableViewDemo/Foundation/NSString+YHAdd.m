...
YHSYNTH_DUMMY_CLASS(NSString_YHAdd)
...
#pragma clang diagnostic ignored "-Wdeprecated-declarations"
        ...
        NSString *encoded = (__bridge_transfer NSString *)CFURLCreateStringByAddingPercentEscapes(kCFAllocatorDefault, (__bridge CFStringRef)self, NULL, CFSTR("!#$&'()*+,/:;=?@[]"), cfEncoding);
        return encoded;
...
- (NSString *)stringByEscapingHTML {
    ...
    for (int i = 0; i < len; i++) {
        ...
        switch (c) {
            ...
            case 38: esc = @"&amp"; break;
            case 39: esc = @"&apos"; break;
            case 60: esc = @"&lt"; break;
            case 62: esc = @"&gt"; break;
            default: break;
        }
        if (esc) {
