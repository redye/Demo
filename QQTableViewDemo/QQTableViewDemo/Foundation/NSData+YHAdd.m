...
#import "NSData+YHAdd.h"
#import "YHKitMacro.h"
#include <CommonCrypto/CommonCrypto.h>
#include <zlib.h>

YHSYNTH_DUMMY_CLASS(NSData_YHAdd)

@implementation NSData (YHAdd)
...
+ (NSData *)dataWithHexString:(NSString *)hexString {
    ...
    NSUInteger lenght = hexString.length;
    if (!lenght) return nil;
    unichar *buf = malloc(sizeof(unichar) * lenght);
    if (!buf) return nil;
    [hexString getCharacters:buf range:NSMakeRange(0, lenght)];
